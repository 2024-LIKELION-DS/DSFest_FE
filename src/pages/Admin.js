    ...
    <>
      <A.Background>
        <A.Admin>
          ...
          <A.Box>
            <A.BackIcon style={{ cursor: "pointer" }} onClick={handleBackClick} src={Back} alt="back" />
              ...
              <A.FormBox>
                <A.Square>
                  <A.LabelBox style={{ marginBottom: "3px" }}>
                    ...
                    <A.BlankDiv>
                      <A.Selection name="categoryName" value={formData.categoryName} onChange={handleSelectChange}>
                        ...
                        <A.Opt value="event" name="program">
                          Event
                        </A.Opt>
                      </A.Selection>
                    </A.BlankDiv>
                  ...
                  <A.LabelBox>
                    ...
                    <A.BlankDiv>
                      <input id="fileInput" type="file" multiple onChange={(event) => handleFileChange(event)} />
                    </A.BlankDiv>
                  </A.LabelBox>
