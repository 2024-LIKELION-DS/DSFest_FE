...
function ExpandableContent({
    ...
    // 이미지 경로 배열
    const imagePaths = [MapImg, MapTitle, MapTitle, MapTitle];
    ...
    const btnStyle = {
        ...
        textAlign: "left",
        margin: "1%",
        boxShadow: "0px 0px 8px rgba(0, 0, 0, 0.2)", // 네 개의 값으로 그림자 추가
    };
        ...
        >
            ...
            >
                <button style={btnStyle} onClick={() => handleButtonClick(0)}>
                    <div style={{ margin: "2%" }}>
                        <div style={textInBtnStyle}>A 구역 </div>
                ...
                <button style={btnStyle} onClick={() => handleButtonClick(1)}>
                    <div style={{ margin: "2%" }}>
                        <div style={textInBtnStyle}> B 구역</div>
                ...
                <button style={btnStyle} onClick={() => handleButtonClick(2)}>
                    <div style={{ margin: "2%" }}>
                        <div style={textInBtnStyle}>C 구역 </div>
                ...
                <button style={btnStyle} onClick={() => handleButtonClick(3)}>
                    <div style={{ margin: "2%" }}>
                        <div style={textInBtnStyle}> D 구역</div>
                ...
                <button style={btnStyle} onClick={() => handleButtonClick(4)}>
                    <div style={{ margin: "2%" }}>
                        <div style={textInBtnStyle}> E 구역</div>
