                  ...
                  <Mp.Infobox>
                    ...
                    <ExpandableContent
                      ...
                      c={
                        applyBrTags ? (
                          <>
                            ISSUE, 서울베스트내과의원, 시원스쿨, 운지문학회,
                            <br />
                            덕우 * Duck in 우이천, 돌멩돌맹, 여운 Afterglow,
                            <br />
                            물꼬, 햅피프로젝트
                          </>
                        ) : (
                      ...
                      e={
                        applyBrTags ? (
                          <>
                            문화기획국, 국어국문학, 덕성 검도부, IT미디어공학,
                            <br />
                            정치외교학, 바이오공학, 덕불, 필름소피,
                            <br />
                            사학, Atractivo, 식품영양학, 생활체육학
                          </>
                        ) : (
                    ...
                    <ExpandableContent
                      ...
                      c={
                        applyBrTags ? (
                          <>
                            ISSUE, 서울베스트내과의원, 시원스쿨,
                            <br />
                            슈퍼(market)이끌림, 덕우 * Duck in 우이천,
                            <br />
                            덕칠이네 야채가게, 또아오락실,
                            <br />
                            어떻게나에게그대란행운이온걸까
                      ...
                      e={
                        applyBrTags ? (
                          <>
                            F.O.R.K, 과학기술대학, 약학대학, 덕냥당, 정치외교학,
                            <br />
                            운현극예술연구회, 천기누설, 몽글몽글, 사회복지학,
                            <br />
                            심리학, 언더덕씨, 열음
                          </>
                        ) : (
                    ...
                    <ExpandableContent
                      ...
                      c={
                        applyBrTags ? (
                          <>
                            기후환경과문화전공, 서울베스트내과의원, EF코리아,
                            <br />
                            여운 Afterglow, chaekbang(책방), 덕새 털-업,
                            <br />
                            물꼬, 락스타 호소인
                          </>
                        ) : (
                      ...
                      e={
                        applyBrTags ? (
                          <>
                            문화기획국, 덕칠이네 야채가게, 이오, 생활체육학,
                            <br />
                            수학, 식품영양학, P.I.C.E., 바이오공학, 국어국문학,
                            <br />
                            아동가족학, F.O.R.K, 덕성 검도부
                          </>
                        ) : (
                    ...
                    <ExpandableContent
                      ...
                      c={
                        applyBrTags ? (
                          <>
                            여명, 서울베스트내과의원, EF코리아, 한빛,
                            <br />
                            나의 마음을 담아, Atractivo, 열음, 덕냥당
                          </>
                        ) : (
                    ...
                    <ExpandableContent
                      ...
                      c={
                        applyBrTags ? (
                          <>
                            원데이 클래스, 서울베스트내과의원, 시원스쿨,
                            <br />
                            오밀조밀, Dearest, 여운 Afterglow,
                            <br />
                            찰나, 모루팔이 덕우, 물꼬
                          </>
                        ) : (
                      ...
                      d={
                        applyBrTags ? (
                          <>
                            덕성여대 영자신문사 VISTA, 과학기술대학,
                            <br />
                            식품영양학, 자세히생각하라XRADIUS, 햅피프로젝트
                          </>
                        ) : (
                      ...
                      e={
                        applyBrTags ? (
                          <>
                            문화기획국, 바이오공학, 운지문학회,
                            <br />
                            디지털소프트웨어공학부, 일어일문학, LBC, 필름소피,
                            <br />
                            덕불, KimKim, 두들링, 덕냥당, 돌멩돌맹
                          </>
                        ) : (
                      ...
                      c={
                        applyBrTags ? (
                          <>
                            원데이 클래스, 서울베스트내과의원,
                            <br />
                            시원스쿨, 귀요미 잡화점, Dearest, Atractivo,
                            <br />
                            덕새 털-업, 폭닥폭닥
                          </>
                        ) : (
